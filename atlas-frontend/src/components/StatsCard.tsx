    ...
    return (
        <div className=" col-span-12 grid grid-cols-3 gap-4">
            <div className=" col-span-1 bg-zinc-900 p-4 rounded-xl min-h-30 border border-zinc-800 hover:scale-[1.01] hover:shadow-lg transition-all duration-300 align-middle justify-center flex flex-col">
                <p className="text-zinc-400 text-sm flex items-center justify-center">Metas concluídas</p>
            ...
            <div className="col-span-1 bg-zinc-900 p-4 rounded-xl min-h-30 border border-zinc-800 hover:scale-[1.01] hover:shadow-lg transition-all duration-300">
                <p className="text-zinc-400 text-sm flex items-center justify-center">Streak</p>
                <h2 className="text-2xl font-bold text-white flex items-center gap-3 align-middle justify-center flex-col">{data.streak} dias<Flame /></h2>
            </div>
            <div className="col-span-1 bg-zinc-900 p-4 rounded-xl min-h-30 border border-zinc-800 hover:scale-[1.01] hover:shadow-lg transition-all duration-300 align-middle justify-center flex flex-col">
                <p className="text-zinc-400 text-sm flex justify-center items-center">Ritimo</p>
                <h2 className="text-2xl font-bold text-white">{data.rhythm.toFixed(1)} metas/dia</h2>
            </div>
        </div>
    );
